...
const formSchema = z
  ...
  .refine(
    ...
    {
      message:
        "O horarário de início não pode ser maior que o horário de término",
      path: ["availableToTime"],
    },
  );

type UpseartDoctorFormProps = {
  doctor?: typeof doctorsTable.$inferInsert;
  onSuccess?: () => void;
};

const UpsertDoctorForm = ({ onSuccess, doctor }: UpseartDoctorFormProps) => {
  ...
  const deleteDoctorAction = useAction(deleteDoctor, {
    ...
    onError: () => {
      toast.error("Error ao deletar médico");
    },
  });
  ...
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle className="font-medium">Adicionar médico</DialogTitle>
                ...
                >
                  <FormControl>
                    <SelectTrigger className="w-full">
                      <SelectValue placeholder="Selecione uma especilidade" />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
              ...
              <FormItem>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value={"6"}>Sabadi</SelectItem>
                  </SelectContent>
                </Select>
                <FormMessage />
              </FormItem>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      meédico e todas as consultas agendadas.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
